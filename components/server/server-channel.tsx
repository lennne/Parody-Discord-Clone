...
const ServerChannel = ({channel, server, role}: ServerChannelProps) => {
    ...
    return (
        <button
        onClick={onClick}
        className={cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full bg-zinc hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
            params?.channelId === channel.id && "bg-zinc-70 0/20 dark:bg-zinc-700")}
        >
            ...
            {/* for all other channels render delete and edit  */}
            ...
            {/* If channel name is general render the lock icon */}
